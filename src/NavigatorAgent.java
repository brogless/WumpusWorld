    ...
    private class LocationRequestsServer extends CyclicBehaviour {
        ...
        private String getAdvice(String content){
            ...
            switch (time){
                ...
                case 4:
                case 6:
                    advicedAction = WumpusWorldAgent.Constants.MESSAGE_FORWARD; time++; break;
                case 1:
                    advicedAction = WumpusWorldAgent.Constants.MESSAGE_RIGHT; time++; break;
                case 3:
                case 5:
                    advicedAction = WumpusWorldAgent.Constants.MESSAGE_LEFT; time++; break;
            }
