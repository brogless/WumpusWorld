...
public class WumpusWorldAgent extends Agent {
    ...
    final static class Constants {
        ...
        static final String INITIAL_WUMPUS_CAVE = "P . . P W G . . . . . . S . P . ";
        static final String OK_MESSAGE = "OK";
        static final String FAIL_MESSAGE = "FAIL";
        static final String WIN_MESSAGE = "WIN";
        static final String SPELEOLOGIST_TURN_LEFT = "SPELEOLOG_LOOK_LEFT";
        static final String SPELEOLOGIST_TURN_RIGHT = "SPELEOLOG_TURN_RIGHT";
        static final String SPELEOLOGIST_MOVE_FORWARD = "SPELEOLOG_MOVE_FORWARD";
        static final String SPELEOLOGIST_GRAB = "SPELEOLOG_GRAB";
        static final String SPELEOLOGIST_SHOOT = "SPELEOLOG_SHOOT";
        static final String SPELEOLOGIST_CLIMB = "SPELEOLOG_CLIMB";
        static final String GAME_INFORMATION = "INFORMATION";

        static final String ADVICE_PROPOSAL = "Help me, navigator, please.";
